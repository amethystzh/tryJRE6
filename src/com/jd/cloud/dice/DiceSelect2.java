...
public class DiceSelect2 {
	...
	private HashMap<String, Integer> groupInfo = new HashMap<>();
...
//	public ArrayList<HashSet<String>> nameList = new ArrayList<HashSet<String>>();
	...
	// 设置candidates内容, been called by DiceSelect2TestParameterized, so set it as package-private
	int setCandidates(String name, Integer star) {
		int errorCode = 0;
		String reg;
		reg = "[\\u4e00-\\u9fa5]+";
	...
	// 设置groupInfo内容
	private void setGroupInfo(String name, Integer reqs) {
		groupInfo.put(name, reqs);
	}
	
	// 获取groupInfo的项数
	private int getGroupNum(HashMap<String, Integer> groupInfo) {
	...
	// 初始化randResult
	private void initRandResult(HashMap<String, Integer> hmGroupInfo/*, ArrayList<HashSet<String>> nameList*/) {
...
//			nameList.add(hse);
	...
	// 指定分配人员
	private void assignRandResult(String groupName, String candidateName) {
	...
	// 分配randResult
	private void setRandResult(HashMap<String, Integer> hmCandidate, HashMap<String, Integer> hmGroupInfo
		...
		HashSet<String> validGroup = new HashSet<>();
	...
	// 获取并输出分配结果
	private void getRandResult(HashMap<String, HashSet<String>> hmRandResult) {
